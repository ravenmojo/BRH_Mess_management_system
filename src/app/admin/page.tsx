...
function AdminDashboardContent() {
  const { isAuthenticated, adminEmail, adminDesignation, isMasterAdmin, adminToken, tier, canManageMess } = useAdminAuth();
  const hasActionAccess = tier !== 'LOW' || Boolean(canManageMess);
                    ...
                    {meal.items.map((item, iIdx) => (
                      <div key={iIdx} className="flex items-center space-x-2">
                        <input
                          type="text"
                          value={item.name}
                          disabled={!hasActionAccess}
                          onChange={(e) => handleItemNameChange(dIdx, mIdx, iIdx, e.target.value)}
                          className="flex-1 px-2 py-1 text-xs bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 disabled:opacity-60 disabled:bg-gray-100 disabled:dark:bg-gray-800"
                        />
                        <select
                          ...
                          className="w-24 px-1 py-1 text-[10px] bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 disabled:opacity-60 disabled:bg-gray-100 disabled:dark:bg-gray-800"
                        >
                        ...
                        <div className="flex items-center space-x-1">
                          ...
                          <input
                            ...
                            className="w-16 px-2 py-1 text-xs bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded text-right font-mono focus:outline-none focus:ring-1 focus:ring-blue-500 disabled:opacity-60 disabled:bg-gray-100 disabled:dark:bg-gray-800"
                          />
                        </div>
                        {hasActionAccess && (
                          <button
