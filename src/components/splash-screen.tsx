...
export function SplashScreen() {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex flex-col items-center justify-center bg-slate-950 text-white transition-all duration-700 ease-in-out ${
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
        ...
        {/* Tagline */}
        <div
          className={`mt-3 transition-all duration-1000 delay-300 ease-out transform ${
            phase === 'enter'
