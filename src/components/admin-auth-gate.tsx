...
export const AdminAuthContext = createContext<AdminAuthContextType>({ isAuthenticated: false });
...
export function AdminAuthGate({ children, title = 'Admin Portal Access' }: AdminAuthGateProps) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Authentication request failed. Please check your network connection.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <AdminAuthContext.Provider value={{ isAuthenticated: isAuth }}>
